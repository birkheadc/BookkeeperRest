...
ENV ASPNETCORE_IS_DEMO=${IS_DEMO}
ENV ASPNETCORE_ENABLE_PASSWORD_CHANGE=${ENABLE_PASSWORD_CHANGE}

ENV ASPNETCORE_CONNECTIONSTRING="server=${DATABASE_NAME};port=3306;database=bookkeeper;user=${DATABASE_USERNAME};password=${DATABASE_PASSWORD}"
